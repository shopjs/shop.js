...
// node_modules/el.js/node_modules/es-is/function.js
...
function mountTo(root, tagName, opts, ctx) {
  ...
  var conf = extend$1$1({ root: root, opts: opts }, { parent: opts ? opts.parent : null });
...
// node_modules/el.js/node_modules/es-is/number.js
// Generated by CoffeeScript 1.12.5
var isNumber;
...
// node_modules/el.js/node_modules/es-is/object.js
// Generated by CoffeeScript 1.12.5
var isObject$1;
...
var isObject$4 = isObject$3 = function(value) {
  return toString(value) === '[object Object]';
};
...
var Ref$1$2 = Ref$1$1 = (function() {
  ...
  Ref.prototype._triggerSetChildren = function(key, value, oldValue) {
    ...
    for (id in ref) {
      child = ref[id];
      if (ref1 = child.key, indexOf$2.call(childKeys, ref1) >= 0) {
        childRemainderKey = key.replace(regExps[child.key], '');
        child.trigger('set', childRemainderKey, value, oldValue);
        results.push(child._triggerSetChildren(childRemainderKey, value, oldValue));
      } else {
...
methods$1 = ['extend', 'get', 'index', 'ref', 'set', 'value', 'on', 'off', 'one', 'trigger'];

refer$2 = function(state, ref) {
  var fn, i, len, method, wrapper;
  if (ref == null) {
    ref = null;
  }
  if (ref == null) {
    ref = new Ref$1$2(state);
  }
  wrapper = function(key) {
    return ref.get(key);
  };
  ...
  for (i = 0, len = methods$1.length; i < len; i++) {
    method = methods$1[i];
    fn(method);
  }
  wrapper.refer = function(key) {
    return refer$2(null, ref.ref(key));
  };
  wrapper.clone = function(key) {
    return refer$2(null, ref.clone(key));
  };
  return wrapper;
};
...
var refer$1$2 = refer$2;

// node_modules/es-cookies/node_modules/es-is/number.js
// Generated by CoffeeScript 1.12.5
var isNumber$4;

var isNumber$5 = isNumber$4 = function(value) {
  return toString(value) === '[object Number]';
};
...
var isArrayLike = function(value) {
  return !!value && !isBool(value) && owns.call(value, 'length') && isFinite(value.length) && isNumber$6(value.length) && value.length >= 0;
};
...
var isArguments = isArgs = function(value) {
  ...
  isOldArguments = !isArray$1$1(value) && isArrayLike(value) && isObject$5(value) && isFn(value.callee);
...
var isFunction$4 = isFn = function(value) {
  var isAlert, str;
...
var isNumber$6 = function(value) {
  return toStr.call(value) === '[object Number]';
};

var isObject$5 = function(value) {
...
CardCVC = (function(superClass) {
  ...
  CardCVC.prototype.onUpdated = function() {
    ...
    if (!this.first) {
      ...
      $input.on('keypress', function(e) {
        var ref, value;
        if (ref = e.which, indexOf$5.call(keys.numeric, ref) < 0) {
          return true;
        }
        value = $input.val() + String.fromCharCode(e.which);
        if (value.length > 4) {
...
var emailRe;
var indexOf$6 = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
...
var cardNumber = function(value) {
  ...
  if (!(indexOf$6.call(card.length, length) >= 0 && (card.luhn === false || luhnCheck(number)))) {
    throw new Error('Enter a valid card number');
  }
  return value;
};
...
var cvc = function(value) {
  ...
  if (card && card.type) {
    if (ref = cvc_.length, indexOf$6.call(card != null ? card.cvcLength : void 0, ref) < 0) {
      throw new Error('Enter a valid cvc');
    }
  } else {
...
function mergeConfigs(parentConfig, childConfig) {
    ...
    for (prop in childConfig) {
        if (hasOwnProp(childConfig, prop)) {
            if (isObject$6(parentConfig[prop]) && isObject$6(childConfig[prop])) {
                res[prop] = {};
...
function configFromInput(config) {
    ...
    if (isUndefined$1(input)) {
        ...
        configFromArray(config);
    } else if (isObject$6(input)) {
        configFromObject(config);
    } else if (isNumber$7(input)) {
        // from milliseconds
...
function createLocalOrUTC (input, format, locale, strict, isUTC) {
    ...
    if ((isObject$6(input) && isObjectEmpty(input)) ||
